...
import 'package:dw9_delivery_app/app/pages/order/widget/payment_type_fields.dart';
  ...
  void _showConfirmProductDialog(OrderConfirmDeleteProductState state) {
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text(
                'Deseja retirar o produto ${state.orderProduct.product.name} da sacola?'),
            actions: [
              TextButton(
                onPressed: () {
    ...
    return BlocListener<OrderController, OrderState>(
      listener: (context, state) {
        state.status.matchAny(
            ...
            emptyBag: () {
              showInfo(
                  'sua sacola está vazia. adicione produtos para realizar o pedido.');
                  ...
                  child: Column(
                    children: [
                      ...
                      OrderField(
                        ...
                        validator:
                            Validatorless.required('onde vai ser a entrega?'),
                      ),
                      const SizedBox(height: 10),
                      OrderField(
                        title: 'Documento CPF',
                        hintText: 'cpf',
                        textController: documentController,
                        validator: Validatorless.required('cade o documento?'),
                      ),
